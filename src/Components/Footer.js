  ...
  return (
    <footer className="footer">
      <div className="row">
        ...
        <div className="clbname">
          <h2>ZERO ONE</h2>
          <p> Study Vault is a place made by zero one coding club team ,</p>
          <p>where you can download all the resources for your study.</p>
        </div>
      ...
      <div className="copyright">
        <h6>&copy; 2024 by zero one coding club mce,motihari.</h6>
      </div>
    </footer>
  )
}
